...
<body>
  ...
  <br />
  <h4 style="text-align: center;margin-bottom: 2em;">Admin Menu</h4>
  <c:if test="${noti==1}">
  <div class="alert alert-success alert-dismissible fade show"" role="alert" style="text-align: center;">
  Ticket Scanned succesfully!!!
</div>
  </c:if>
  <div style="text-align: center;">
    <div class="container">
      <a class="btn btn-outline-secondary btn-lg" style="color: black;margin-bottom: 2em;" href="">View Tickets Booked
      </a>
      <br />
      <a class="btn btn-outline-secondary btn-lg" style="color: black;margin-bottom: 2em;" href="/changeloc">Change bus
        location</a>
