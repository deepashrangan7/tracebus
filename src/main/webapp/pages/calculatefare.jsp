...
<div style="float: right;margin-bottom: 2em;">
  <f:form action="calculatefare" method="post" class="form-inline" modelAttribute="searchbean">
  ...
  <table class="table table-hover">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><c:out value="${locbus.fare}" />
        </td>
     <td>
     <a class="btn btn-primary" href="/booktickets?bus_no=${locbus.bus_no}&fare=${locbus.fare}&pickup=${searchbean.boarding}&drop=${searchbean.destination}" role="button">
     BookNow
     </a>
