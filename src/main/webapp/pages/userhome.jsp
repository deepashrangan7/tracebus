...
<body>
		...
		<div class="collapse navbar-collapse" id="navbarTogglerDemo02">
			<ul class="navbar-nav mr-auto mt-2 mt-lg-0">
				...
				<li class="nav-item active text-light"><a
					class="nav-link text-light" href="/help">Help <span
						class="sr-only">(current)</span></a></li>
				<li class="nav-item"><a class="nav-link text-light"
					href="/logout">Logout</a></li>
				<!--here-->

				<li class="nav-item dropdown" style="padding-left: 25%;"><a
					class="nav-link text-light" href="#" id="navbarDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> <i class="fa fa-bell">&nbsp;<i
							style="color: red">${fn:length(notic)}</i>&nbsp;&nbsp;Notification
					</i>
				</a>
					<ul class="dropdown-menu">
						<c:choose>
							<c:when test="${fn:length(notic)>0}">

								<li class="head text-light bg-dark">
									<div class="row">
										<div class="col-lg-12 col-sm-12 col-12">
											<span>Notifications (${fn:length(notic)})</span>
										</div>
								</li>
								<c:forEach items="${notic}" var="t">

									<li class="notification-box">
										<div class="row">
											<!-- div class="col-lg- col-sm-3 col-3 text-center">
                  <img src="news.jpg" class="w-50 rounded-circle">
                </div-->

											<div class="col-lg-12 col-sm-12 col-12">
												<strong class="text-info" style="text-align: center;">Bus
													Number : ${t.bus_no} Update</strong>
												<div>
													<c:if test="${t.next!=t.current}">
													Bus Number <b>${t.bus_no}</b> has reached <b>${t.current}</b>
													next stop is <b>${t.next}</b>
													</c:if>
													<c:if test="${t.next==t.current}">
													Bus Number <b>${t.bus_no}</b> has reached <b>${t.current}</b>
              ...
              <div class="row">
                ...
                <div class="col-lg-12 col-sm-12 col-12" style="text-align: center;">
                  <strong class="text-info" style="text-align: center;">David John</strong>
                  <div >
                    Lorem ipsum dolor sit amet, consectetur
								...
								<li class="footer bg-dark text-center"><a href="/allnoti"
									class="text-light">View All</a></li>
	...
	<c:if test="${notifi!=null and notifi!='' and notifi!=' '}">
		<div class="alert alert-success alert-dismissible fade show"
			role="alert">
			<strong>${notifi}</strong>
			<button type="button" class="close" data-dismiss="alert"
				aria-label="Close">
				<span aria-hidden="true">&times;</span>
			</button>
			...
			<div class="carousel-inner" role="listbox">
				<div class="carousel-item active">
					...
					<div class="carousel-caption">
						<h3 class="h3-responsive" style="color: black;">Now Track
							Your Busses</h3>
						<p style="color: black;">Trace enable to get location of the
							bus and track it . Even you can get notified when bus reaches
							your stop ! Happy Tracking!!!</p>
					</div>
				</div>
				<div class="carousel-item">
					...
					<div class="carousel-caption">
						...
						<p>now you can book your bus tickets even before riding. You
							can cancel the tickets at any time before boarding!!!</p>
					</div>
				</div>
				<div class="carousel-item">
					<!--Mask color-->
					...
					<div class="carousel-caption">
						...
						<p>Our Trace app reached over 1.2million user in past one
							month. Thank you for your contributions !!!Happy Tracing!!!</p>
					</div>
				</div>
			</div>
			<!--/.Slides-->
	...
	<div class="card-group">
		<div class="card">
			...
			<div class="card-body">
				...
				<p class="card-text">Enter the bus number which you want to know
					the location and get the location of your bus.This will help you to
					reduce your waiting time.</p>
			</div>
		...
		<div class="card">
			...
			<div class="card-body">
				...
				<p class="card-text">Book your Bus ticket at a click. Book now
					and get peaceful journey. Don't worry you can cancel your tickets
					at any point of time before boarding...</p>
			</div>
			<div class="card-footer">
		...
		<div class="card">
			...
			<div class="card-body">
				...
				<p class="card-text">Know your fare before you board . You can
					calculate the amount and keep exact change to make life easier</p>
			</div>
			<div class="card-footer">
				<a class="btn btn-primary active btn-md" href="/calculatefare">Calculate
					Fare</a>
			</div>
		</div>
	</div>
	...
	<div class="card-group">
		<div class="card">
			...
			<div class="card-body">
				...
				<p class="card-text">Get complete details of your bookings.
					check the status of your bookings.</p>
			</div>
			<div class="card-footer">
		...
		<div class="card">
			...
			<div class="card-body">
				...
				<p class="card-text">enter your stop of boarding and the
					location where you want to go and find your suitable busses with
					timings...</p>
			</div>
			<div class="card-footer">
		...
		<div class="card">
			...
			<div class="card-body">
				...
				<p class="card-text">Get the latest information about our app
					and the new updates which is yet to be released</p>
			</div>
			<div class="card-footer">
				<a class="btn btn-primary active btn-md" href="/newsfeed">Get to
					know</a>
			</div>
		</div>
	</div>
