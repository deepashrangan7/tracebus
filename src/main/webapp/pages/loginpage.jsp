		...
		<div class="collapse navbar-collapse" id="navbarTogglerDemo02">
			<ul class="navbar-nav mr-auto mt-2 mt-lg-0">
				<li class="nav-item active text-light"><a
					class="nav-link text-light" href="/">Back <span class="sr-only">(current)</span></a>
				</li>
		...
		<div class="container">
			...
			<div class="row" style="text-align: center;">
				<div class="col-md-12 col-md-12 col-md-offset-"
					...
					<h1 class="text-center login-title" style="font-weight: bolder;">Sign
						in</h1>
					<div class="account-wall">
						...
						<f:form class="form-signin" action="/login" method="POST"
							modelAttribute="lBean">
							<c:choose>
								<c:when test="${vale==1 }">
									<f:input type="text" class="form-control" placeholder="Email"
										disabled="true" name="email1" path="email" />

									<f:input type="hidden" class="form-control" placeholder="Email"
								...
								<c:otherwise>
									<f:input type="text" class="form-control" placeholder="Email"
										autofocus="true" name="email" path="email" />
									<br />
							...
							<c:choose>
								<c:when test="${vale==1}">
									<f:input type="password" class="form-control"
										placeholder="Password" autofocus="true" name="password"
										path="password" />
									<br />
									<i style="color: red;"><f:errors path="password"></f:errors></i>
